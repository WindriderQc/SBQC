...
//rsconst IN_PROD = process.env.NODE_ENV === 'production'  // for https channel...  IN_PROD will be true if in production environment
...
app
  ...
  .use('/vip',     require('./routes/login.routes'))
