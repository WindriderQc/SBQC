...
def run(playwright):
    ...
    try:
        ...
        slider_handle.fill("360")

        # Wait for rendering.
        page.wait_for_timeout(20000)

        # Take a screenshot for visual verification.
        page.screenshot(path="jules-scratch/verification/iss_prediction_verification.png")

        print("Screenshot saved to jules-scratch/verification/iss_prediction_verification.png")
